...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://sso.solarcat.cn/page/register"><span>欢迎注册</span></a>
	</div>
			...
			<form id="regForm_mod" name="regForm_mod" method="post" action="">
				...
				<li class="regMb30">
					...
					<span class="regM defaultBorder"> 
						<input id="regName" name="username" class="regInput" type="text" onkeyup="mail_div(event);" onfocus="showtip('regName','userMamErr',8);" onblur="ckmem();" autocomplete="off" maxlength="80" /> <em></em>
					</span> 
				...
				<li>
					<label><font>*</font> 登录密码：</label>
						<span class="regM defaultBorder"> <input id="pwd" name="password" class="regInput" autocomplete="off" type="password" onfocus="showPwdtip('password','passwordErr',2);" onkeyup="ckpwd(0,1);" onblur="ckpwd(0,0);" /> <em></em>
						</span> 
