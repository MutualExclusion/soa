...
//    }
     ...
     * @return
     */
    public static SolarCatResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, SolarCatResult.class);
            }
     ...
     * @return
     */
    public static SolarCatResult format(String json) {
        try {
            return MAPPER.readValue(json, SolarCatResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static SolarCatResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
