...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://sso.solarcat.cn/page/login"><span>欢迎登录</span> </a>
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<a href="#" target="_blank"><img src="/images/06f42c372620f92b40da77a8b23cdf7f.png" alt="" /></a>
		</div>
		<!-- login -->
		<div class="login">
			...
			<div class="login_box clear">
				<ul class="loginnav">
					<li class="curr" mark="sfbest"><em></em>用户名登录</li>
				</ul>
				...
				<div class="logincon">
					<ul>
						<form id="formlogin" method="post" action="">
							...
							<li style="display: none;"><span class="title">BGCode</span> <span class="border"> <input type="hidden" name="bgcode" id="bgcode" value="sfbest" class="loginText" /> <em class="icon1" id="bgcode_em"></em>

							</span> <span id="uNameErr"></span></li>
							<li><span class="title">手机/验证邮箱/用户名<font style="padding-left: 20px" class="error_line" color="#ff0000"></font></span> <span class="border" style="position: relative"> <input id="username" name="username" type="hidden" accesskey="n" value="" size="25" autocomplete="off" /> <input
									class="new-input1 new-color" tabindex="1" data-clear-btn="true" id="loginname" size="25" autocomplete="off" htmlescape="true" title="请输入用户名"
								/> <em class="icon1" id="usernamelogo"></em> <span style="position: absolute; font-size: 14px; left: 5px; top: 9px; display: none;" class="sfbest_username_place">请输入手机号/邮箱/用户名</span>
							</span> <span id="sfbestNameErr"></span></li>

							<li class="m-t12"><span class="title">登录密码</span> <span class="border" style="position: relative"> <input id="password" name="password" class="required" tabindex="2" type="password" value="" autocomplete="off" /> <em class="icon2" id="passwordlogo"></em> <span
									style="position: absolute; font-size: 14px; left: 5px; top: 9px; display: none;" class="sfbest_password_place"
								>密码</span>
							</span> <span id="sfbestPwdErr"></span></li>
							<div class="clear"></div>
							<li>
							...
							<li class="m-t5" id="btn_sub"><input type="hidden" name="lt" value="LT-7055357-If097ZfAK0WqnrgGeScsi6SndWWZFv-sfbest" /> <input type="hidden" name="execution"
							...
							/> <input type="hidden" name="_eventId" value="submit" /> <a href="javascript:void(0)" id="login_sub" class="login_btn">登录</a></li>
							<div></div>
						</form>
					</ul>
				</div>
				...
				<ul class="blink">
					<li class="p-f10">
						...
						<div>
							<a href="#" class="link">QQ</a>&nbsp;|&nbsp; <a href="#" class="link">新浪微博</a> &nbsp;|&nbsp; <a href="#" class="link">腾讯微博</a> &nbsp;|&nbsp; <a href="#" class="link">支付宝</a>
						</div>
					</li>
				</ul>
			</div>
